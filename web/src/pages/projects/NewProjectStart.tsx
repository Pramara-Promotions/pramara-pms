      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-1 space-y-4">
          <div>
            ...
            <input className="w-full rounded border px-3 py-2" placeholder="e.g., Spring collection" />
          </div>

          <div>
            <label className="block text-sm text-gray-600 mb-1">Start from</label>
        ...
        <div className="col-span-2 rounded-xl border p-4 bg-white dark:bg-neutral-900 dark:border-neutral-800">
          <div className="text-sm text-gray-500 mb-2">Project snapshot</div>
          <div className="h-64 rounded-md border bg-gray-50 dark:bg-neutral-800 dark:border-neutral-700 flex items-center justify-center text-sm text-gray-500">
