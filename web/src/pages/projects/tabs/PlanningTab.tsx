...
import { Calendar, Users, Box, Calculator, CheckCircle } from 'lucide-react';
...
export default function PlanningTab() {
  ...
  const planningCards = [
    ...
    },
    {
      ...
      description: 'Worker assignments and scheduling',
      icon: Users,
      link: `/planning/workforce?projectId=${projectId}`,
